...
public class BikeAdapterAdminBikes extends RecyclerView.Adapter<BikeAdapterAdminBikes.ImageViewHolder> {
    ...
    public BikeAdapterAdminBikes(Context bikes_context, List<Bikes> bikes_ToRent_uploads){
