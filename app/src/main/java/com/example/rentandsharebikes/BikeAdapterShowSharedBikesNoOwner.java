...
public class BikeAdapterShowSharedBikesNoOwner extends RecyclerView.Adapter<BikeAdapterShowSharedBikesNoOwner.ImageViewHolder>{
    ...
    public BikeAdapterShowSharedBikesNoOwner(Context bikes_context, List<BikesShare> bikes_uploads){
