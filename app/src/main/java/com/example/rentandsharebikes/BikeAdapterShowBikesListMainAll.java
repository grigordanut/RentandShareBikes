...
public class BikeAdapterShowBikesListMainAll extends RecyclerView.Adapter<BikeAdapterShowBikesListMainAll.ImageViewHolder> {
    ...
    public BikeAdapterShowBikesListMainAll(Context bikes_context, List<Bikes> bikes_ToRent_uploads){
