...
public class BikeAdapterMainShowBikesToShare extends RecyclerView.Adapter<BikeAdapterMainShowBikesToShare.ImageViewHolder> {
    ...
    public BikeAdapterMainShowBikesToShare(Context bikes_context, List<BikesShare> bikes_uploads){
