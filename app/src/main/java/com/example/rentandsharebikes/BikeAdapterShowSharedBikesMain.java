...
public class BikeAdapterShowSharedBikesMain extends RecyclerView.Adapter<BikeAdapterShowSharedBikesMain.ImageViewHolder> {
    ...
    public BikeAdapterShowSharedBikesMain(Context bikes_context, List<BikesShare> bikes_uploads){
