...
public class BikeStoreImageShowBikesListCustomer extends AppCompatActivity implements BikeStoreAdapterCustom.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bikeStoreAdapterCustom = new BikeStoreAdapterCustom(BikeStoreImageShowBikesListCustomer.this, bikeStoresList);
        bikeStoreRecyclerView.setAdapter(bikeStoreAdapterCustom);
        bikeStoreAdapterCustom.setOnItmClickListener(BikeStoreImageShowBikesListCustomer.this);
    }
    ...
    public void onItemClick(int position) {
        ...
        Intent store_Intent = new Intent(BikeStoreImageShowBikesListCustomer.this, BikeImageShowBikesListCustomer.class);
