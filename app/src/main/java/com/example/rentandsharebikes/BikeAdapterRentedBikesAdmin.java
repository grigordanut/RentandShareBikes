...
public class BikeAdapterRentedBikesAdmin extends RecyclerView.Adapter<BikeAdapterRentedBikesAdmin.ImageViewHolder> {
    ...
    public BikeAdapterRentedBikesAdmin(Context bikes_context, List<RentedBikes> bikes_uploads) {
