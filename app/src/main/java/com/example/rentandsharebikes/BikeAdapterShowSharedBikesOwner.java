...
public class BikeAdapterShowSharedBikesOwner extends RecyclerView.Adapter<BikeAdapterShowSharedBikesOwner.ImageViewHolder> {

    private final Context bikesContext;
    private final List<BikesShare> bikesUploads;

    public BikeAdapterShowSharedBikesOwner(Context bikes_context, List<BikesShare> bikes_uploads){
