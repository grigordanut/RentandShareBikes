...
public class BikeAdapterShowBikesListMainPage extends RecyclerView.Adapter<BikeAdapterShowBikesListMainPage.ImageViewHolder>{
    ...
    public BikeAdapterShowBikesListMainPage(Context bikes_context, List<Bikes> bikes_ToRent_uploads){
